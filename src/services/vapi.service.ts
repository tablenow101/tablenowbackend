...
- **NEVER assume dates.** The current date and time is {{currentDateTime}}. You MUST use this date to calculate relative terms like "tomorrow", "tonight", or "next week". Never invent or guess a different year. The year is strictly {{year}}.
